...
title: Albatross | Compression Packing Cubes
metaDescription: At Albatross, we focus on creating minimal, affordable items built to last. When you buy an Albatross product, you can trust that it won’t let you down.
...
<section class="hero section-dark section-block">
...
<section class="section-light section-block">
  <div class="container split-grid">
    <div class="section-heading">
      <h2>Our story</h2>
    </div>
    <div class="copy-large">
      <p>At Albatross, we focus on creating minimal, affordable items built to last for our customers. When you buy an Albatross product, you can trust that it won’t let you down.</p>
    </div>
  </div>
</section>

<section class="section-white section-block">
  <div class="container split-grid">
    <div class="section-heading">
      <p class="tagline">Let's look at</p>
...
<section class="cta section-dark section-block">
  <div class="container cta-row">
    <h2>Visit our store</h2>
    <a class="btn btn-primary" href="https://www.amazon.co.uk/dp/B0CRCJN7DB" target="_blank" rel="noopener">Find us on Amazon</a>
  </div>
</section>
